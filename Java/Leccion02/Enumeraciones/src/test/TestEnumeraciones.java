...
/**
 * Clase de prueba para demostrar el uso de enumeraciones en Java.
 * Muestra cómo declarar, pasar como parámetro y usar en estructuras switch.
 */
public class TestEnumeraciones {
    ...
    /**
     * Método que recibe un día de la semana y muestra su posición usando switch.
     * @param dias El día de la semana a evaluar (tipo Dias)
     * 
     * Demuestra:
     * 1. Cómo usar enumeraciones como parámetros
     * 2. Cómo hacer switch con enumeraciones
     * 3. Buenas prácticas con break y default
     */
